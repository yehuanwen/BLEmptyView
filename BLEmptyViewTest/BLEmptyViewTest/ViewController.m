...
- (void)loadView {
    ...
    BLEmptyView *horizontalEmptyView = [[BLEmptyView alloc] initWithImage:[UIImage imageNamed:@"jiangpin_face"] text:@"You do not have a prize yeah!"];
    ...
    BLEmptyView *verticalEmptyView = [[BLEmptyView alloc] initWithImage:[UIImage imageNamed:@"jiangpin_face"] text:@"水平布局文字不支持多行！垂直布局文字支持多行！" style:BLEmptyViewStyleVertical];
    ...
    BLEmptyView *emptyView1 = [[BLEmptyView alloc] initWithImage:[self imageWithColor:[UIColor brownColor]] text:@"height of image is little than label"];
    emptyView1.y = 320;
    emptyView1.textColor = [UIColor blueColor];
    [self.view addSubview:emptyView1];

    BLEmptyView *emptyView2 = [[BLEmptyView alloc] initWithImage:[self imageWithColor:[UIColor redColor]] text:@"图片的高度比标签小" style:BLEmptyViewStyleVertical];
    emptyView2.y = 380;
